...
public class CategoriaImputacionConfiguration : IEntityTypeConfiguration<CategoriaImputacion>
{
    public void Configure(EntityTypeBuilder<CategoriaImputacion> b)
    {
        b.ToTable("categorias_imputacion");
        b.HasKey(x => x.Id);
